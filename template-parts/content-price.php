                    ...
                    <div class="<?php if(($i%2)==0){echo 'bg-white rounded shadow position-relative';} else{echo'bg-light rounded';}?>">
                        ...
                        <div class="p-5 pt-0">
                            <h1 class="display-5 mb-3">
                                ...
                                <?php echo $price_currency ['value'];?></small><?php echo $price_amount ;?><small
                            ...
                            <?php
                                ...
                                ?>
                                        ...
                                        <?php echo $feature['price_feature_title'];?></span><i class="<?php if($feature['price_feature_active']['value'] == 'show' ){echo'fa fa-times text-danger';} else{echo'fa fa-check text-primary';}?> pt-1"> </i></div>
                                <?php
                                    }
                                ?>
